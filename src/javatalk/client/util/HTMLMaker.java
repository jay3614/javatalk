...
public class HTMLMaker {
	...
	private void setProfile(boolean isMine, String userName, int profileNum) {
		String right = 		
				...
				"			</th>" + 
				"   	    <th rowspan=\"2\">" +
				"				<img src=\"file:"+FilePath.PROFILEPATH.toString()+"profile"+profileNum+".png"+"\" height=\"55\" width=\"55\">" +
				"			</th>";		
		profile.put(true, right);
		
		String left = 	
				"   	    <th rowspan=\"2\">" +
				"				<img src=\"file:"+FilePath.PROFILEPATH+"profile"+profileNum+".png"+"\" height=\"55\" width=\"55\">" +
				"			</th>" +
				"	    	<th style=\"text-align:" + align.get(isMine) + ";\">" +
								userName +
				"			</th>";
